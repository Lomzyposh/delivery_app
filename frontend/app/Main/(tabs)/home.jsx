...
export default function Home() {
    ...
    const openFavourite = () => {
        router.push({ pathname: "/Main/listMeals", params: { fav: "1" } });
    ...
    return (
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.header}>
                ...
                <TouchableOpacity style={styles.addressSubRow} onPress={() => openFavourite()}>
                    <Ionicons name="heart-outline" size={25} color={theme.text} />
                </TouchableOpacity>
            </View>

            <HomeSearch theme={theme} styles={styles} />
            ...
            <RandomDeals onPressItem={(meal) =>
                router.push({ pathname: "/meal-details", params: { id: meal._id } })
            }
            />
            <HomeRestaurantsRail />
